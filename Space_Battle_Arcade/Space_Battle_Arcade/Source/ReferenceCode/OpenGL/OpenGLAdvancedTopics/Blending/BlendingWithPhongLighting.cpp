...
namespace
{
	...
	void true_main()
	{
		...
		//problem: using a plane the normals are only valid on one side of the plane :\
		//either need to use some linalg in shaders to determine which face the light is on or use a slim box with potenital face culling
		//however that probably wouldn't be great either because you can see light on a window from the side of the window that is opposite to the light.
		float planeVertices[] = {
			// xyz                 //normals         // st
		...
		GLuint textureWindowId = textureLoader("Textures/blending_transparent_window.png", GL_TEXTURE0);
