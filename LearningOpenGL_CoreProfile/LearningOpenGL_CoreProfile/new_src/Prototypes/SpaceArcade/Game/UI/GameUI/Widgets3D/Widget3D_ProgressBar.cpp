...
namespace SA
{
	...
	void Widget3D_ProgressBar::postConstruct()
	{
		...
		laser_progressVerticalBar = pool.requestLaserObject();

		laser_boxTop = pool.requestLaserObject();
		laser_boxLeft = pool.requestLaserObject();
		laser_boxBottom = pool.requestLaserObject();
		laser_boxRight = pool.requestLaserObject();
