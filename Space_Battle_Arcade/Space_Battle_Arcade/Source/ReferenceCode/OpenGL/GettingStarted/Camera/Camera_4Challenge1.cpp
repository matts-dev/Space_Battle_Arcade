...
namespace
{
	...
	{
		//fancy projection method works too... but perhaps overkill. cameraFront.x is already the result of xProjections 
		//float xProjection = glm::dot(glm::vec3(1.f, 0.f, 0.f), cameraFront);
		//float zProjection = glm::dot(glm::vec3(0.f, 0.f, 1.f), cameraFront);
		//glm::vec3 frontInXZPlane(xProjection, 0, zProjection);
		//frontInXZPlane = glm::normalize(frontInXZPlane);

		glm::vec3 frontInXZPlane(cameraFront.x, 0, cameraFront.z);
		frontInXZPlane = glm::normalize(frontInXZPlane);
		...
		{
			cameraPosition -= frontInXZPlane * cameraSpeed;
		}
