...
namespace SA
{
	void ForwardRenderingStateMachine::begin_HdrStage(glm::vec3 clearColor)
	{
	...
	void ForwardRenderingStateMachine::begin_ToneMappingStage(glm::vec3 clearColor)
	{
		...
		if (bool bCopyDepthInformation = true)
		{
			...
			ec(glBindFramebuffer(GL_DRAW_FRAMEBUFFER, 0));
