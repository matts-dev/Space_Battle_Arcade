...
//------------------------------------------------------------------------------------------------------------------
		...
		//test models
		Transform LeftFighterXform = { glm::vec3(-5,0,-5), glm::vec3(0,45.0f,0), glm::vec3(0.33f,0.33f,0.33f) };
		Model LeftFighterModel("Models/TestModels/SpaceArcade/Fighter/SGFighter.obj");

		Transform LeftCarrierXform = { glm::vec3(-8,0,0), glm::vec3(0,90.0f,0), glm::vec3(0.25f,0.25f,0.25f) };
		Model LeftCarrierModel("Models/TestModels/SpaceArcade/Carrier/SGCarrier.obj");

		Transform RightFighterXform = { glm::vec3(5,0,-5), glm::vec3(0,-45.0f,0), glm::vec3(0.25f, 0.25f, 0.25f) };
		Model RightFighterModel("Models/TestModels/SpaceArcade/Fighter/SGFighter.obj");

		Transform RightCarrierXform = { glm::vec3(8,0,0), glm::vec3(0,-90.0f,0), glm::vec3(0.25f, 0.25f, 0.25f) };
		Model RightCarrierModel("Models/TestModels/SpaceArcade/Carrier/SGCarrier.obj");
...
//------------------------------------------------------------------------------------------------------------------
		...
		*/
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			DrawMesh(LeftFighterModel, LeftFighterXform, shader);
			DrawMesh(LeftCarrierModel, LeftCarrierXform, shader);
			DrawMesh(RightFighterModel, RightFighterXform, shader);
			DrawMesh(RightCarrierModel, RightCarrierXform, shader);
