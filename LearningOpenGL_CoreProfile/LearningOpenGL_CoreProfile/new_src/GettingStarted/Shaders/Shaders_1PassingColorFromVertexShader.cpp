...
namespace
{
	...
	void true_main()
	{
		...
		int maxNumVertAtrributes;
		glGetIntegerv(GL_MAX_VERTEX_ATTRIBS, &maxNumVertAtrributes);
		std::cout << "maximum number of vertex attributes for this GPU: " << maxNumVertAtrributes << std::endl;
