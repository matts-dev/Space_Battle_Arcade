...
namespace
{
	...
	const char* frag_shader_src = R"(
				...
				void main(){
					...
					//gl_FragCoord is in the window's units(eg [0, 800]) (it is *not* in NDC [-1,1] ranges)
					//gl_FargCoord.xy is basically the actual pixel coordinate
					//note: gl_FargCoord is a read-only variable
