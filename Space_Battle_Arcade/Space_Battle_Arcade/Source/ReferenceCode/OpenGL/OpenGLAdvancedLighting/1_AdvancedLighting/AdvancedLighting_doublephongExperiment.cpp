...
namespace
{
	...
	const char* frag_shader_src = R"(
				...
				//switch between phong and blinnphong
				uniform bool bUseBlinnPhong = false;
				...
				void main(){
					...
					if(!bUseBlinnPhong){
						...
						//----------------------------------
						specularAmount = specularAmount + pow(max(dot(toView, toLight), 0), SPEC_SHININESS);
						//----------------------------------
	...
	void true_main()
	{
		...
		{
			//--------------------------------------------------------------------------------------------------------------------------
			//shinnyness is controlled within the shader
			shader.setUniform1i("bUseBlinnPhong", enableBlinn);
			//--------------------------------------------------------------------------------------------------------------------------
