...
namespace
{
	...
	void true_main()
	{
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			shader.setUniform3f("light.ambientIntensity", ambientStrength, ambientStrength, ambientStrength); //for non-white lights you want to use a small constant times the light's color for each
			shader.setUniform3f("light.diffuseIntensity", diffuseStrength, diffuseStrength, diffuseStrength);
