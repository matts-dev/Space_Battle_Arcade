...
namespace
{
	...
	const char* vertex_shader_src = R"(
				...
				out mat3 TBN; //tangent_bitangent_normal
	...
	const char* frag_shader_src = R"(
				...
				in mat3 TBN; //tangent_bitangent_normal
	...
	void true_main()
	{
		...
		for (int vertex = 0; vertex < numVertices; vertex += 3)
		{
			...
			{
				//we're calculating 3 vertices at a time, so store the bitangent/tangents in the adjacent 2 vertices too
