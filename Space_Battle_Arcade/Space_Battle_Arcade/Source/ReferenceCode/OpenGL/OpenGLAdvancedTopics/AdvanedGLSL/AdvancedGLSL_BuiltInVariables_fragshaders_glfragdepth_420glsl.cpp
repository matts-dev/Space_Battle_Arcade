...
namespace
{
	...
	const char* frag_shader_src = R"(
				...
				//allows conditional writing to help mitigate some of the loss from preventing early depth testing
				...
				void main(){
					...
					if(gl_FragCoord.x > 400)
						fragmentColor = glm::vec4(1, 0, 0, 1.f);
					else
						fragmentColor = glm::vec4(0, 1, 0, 1.f);
