...
///-------------------------------------------------------------------------------------------
	...
	void true_main()
	{
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			//shader.setUniform1i("prefilterMap", 6);
			//shader.setUniform1i("BRDF_LUT", 7);
			glActiveTexture(GL_TEXTURE0); glBindTexture(GL_TEXTURE_2D, albedoTexure);
			glActiveTexture(GL_TEXTURE1); glBindTexture(GL_TEXTURE_2D, normalTexture);
			glActiveTexture(GL_TEXTURE2); glBindTexture(GL_TEXTURE_2D, metalicTexture);
			glActiveTexture(GL_TEXTURE3); glBindTexture(GL_TEXTURE_2D, roughnessTexture);
			//glActiveTexture(GL_TEXTURE4); glBindTexture(GL_TEXTURE_2D, aoTexture); 
