...
namespace
{
	...
	void true_main()
	{
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			//glm::mat4 view = glm::lookAt(cameraPosition, glm::vec3(0.f, 0.f, 0.f), worldUp); //why doesn't this break the matrix? because it is actually specifying the center and the 
			//glm::mat4 view = glm::lookAt(cameraPosition, cameraPosition, worldUp); //this breaks the view matrix because the direction vector is calculated to be zero (its camPos - camPos)
