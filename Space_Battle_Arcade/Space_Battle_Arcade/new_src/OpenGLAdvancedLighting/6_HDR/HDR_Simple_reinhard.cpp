...
namespace
{
	...
	void true_main()
	{
		...
		//textures
		bool useSRGB = false;
		GLuint diffuseMap = textureLoader("Textures/woodfloor.png", GL_TEXTURE0, useSRGB); //lighting calculations set up for non-gamma corrected rendering
		GLuint specularMap = textureLoader("Textures/woodfloor.png", GL_TEXTURE1, useSRGB);
