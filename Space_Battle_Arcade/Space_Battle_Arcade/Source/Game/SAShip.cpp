...
#include "Game/Components/ShipEnergyComponent.h"
...
#include "Game/UI/GameUI/Widgets3D/Widget3D_Ship.h"
...
namespace SA
{
	...
	float targetPlayerThresholdDist2 = static_cast<float>(std::pow(20.f, 2.f));
