...
#include "Game/GameEntities/AvoidMesh.h"
...
#include "Game/Tools/DebugTools/AIDebuggerWidget.h"
...
namespace SA
{
	...
	log("BasicTestSpaceLevel", LogLevel::LOG_WARNING, "ERROR_CHECK_GL_RELEASE enabled. For performance this should be disabled for final release builds.");
		...
		const bool bShouldUseConfigSpawns = hasLevelConfig();
		...
		// test asteroid
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		if (bool bEnableTestAsteroid = false)
		{
			if (const sp<ModSystem>& modSystem = game.getModSystem())
			{
