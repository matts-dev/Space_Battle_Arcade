...
//--------------------------------------------------
	...
	void true_main()
	{
		...
		Transform BoundingBox = { { 0.0f, 0.0f, -20.0f },{ 0, 0, 0 },{ 5.0f, 5.0f, 25.0f } };
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			if (rotateLight)
			{
				...
				float displacement = -45 * range_0_to_1;
				model = glm::translate(model, glm::vec3(0, 0, displacement));
			}
			...
			shader.setUniform1f("light.linear", 0.025f);
			shader.setUniform1f("light.quadratic", 0.025f);
