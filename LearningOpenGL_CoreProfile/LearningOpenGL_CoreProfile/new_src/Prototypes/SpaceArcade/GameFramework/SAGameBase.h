...
namespace SA
{
	...
	*/
	...
	public:
		...
		// #todo REFACTOR: returning raw reference like this allows for assignment; returning const sp<>& may be better, but may imply they're null (be impossible); Perhaps add shared_ref feature, that's sref<>, and return const sref<system>
