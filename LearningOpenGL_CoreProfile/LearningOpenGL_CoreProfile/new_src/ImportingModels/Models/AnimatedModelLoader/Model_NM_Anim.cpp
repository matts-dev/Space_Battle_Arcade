...
void Model_NM_Anim::drawInstanced(Shader& shader, uint32_t instanceCount)
{
	for (uint32_t i = 0; i < meshes.size(); ++i)
	{
...
void Model_NM_Anim::setInstancedModelMatricesData(glm::mat4* modelMatrices, uint32_t count)
{
...
AnimationData Model_NM_Anim::startAnimation(uint32_t animationID, bool bLoop)
{
...
void Model_NM_Anim::prepareAnimationsForData(AnimationData& inOut_AnimationData)
{
...
void Model_NM_Anim::sendBoneTransformsToShader(Shader& shader, const char* uniformMat4ArrayName)
{
...
void Model_NM_Anim::calculateAnimationTransforms(
...
aiMatrix4x4 Model_NM_Anim::interpolatePositionKeys(aiNodeAnim* animNode, float animationTimeInTicks)
{
...
aiMatrix4x4 Model_NM_Anim::interpolateRotationKeys(aiNodeAnim* animNode, float animationTimeInTicks)
{
...
aiMatrix4x4 Model_NM_Anim::interpolateScaleKeys(aiNodeAnim* animNode, float animationTimeInTicks)
{
...
glm::vec3 Model_NM_Anim::toGlmVec3(const aiVector3D& aiVec3)
{
	return glm::vec3(aiVec3.x, aiVec3.y, aiVec3.z);
}

aiVector3D Model_NM_Anim::toAiVec3(const glm::vec3& glmVec3)
{
	return aiVector3D(glmVec3.x, glmVec3.y, glmVec3.z);
}

aiMatrix4x4 Model_NM_Anim::toAiMat4(glm::mat4 glmMat4)
{
	aiMatrix4x4 result;
...
glm::mat4 Model_NM_Anim::toGlmMat4(aiMatrix4x4 aiMat4)
{
	glm::mat4 result;
	//ai row 0
...
void Model_NM_Anim::markNodesForBone(const std::string& boneName)
{
...
aiNode* Model_NM_Anim::findNamedNode(const char* name, aiNode* startNode)
{
